                                        ...
                                        <form style='flex: 2' v-on:submit="envoyerNouveauDiplome">
                                                ...
                                                <div class="form-row ml-4 mr-4">
                                                  <div class="form-group  ">
                                                    ...
                                                    <input class="form-control" id="inputEmail4" v-model="nouveauDiplome.code" minlength="6" maxlength="6" placeholder="6 caractères" required>
                                                  </div>
                                                  <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Libellé</label>
                                                    <input class="form-control" id="inputPassword4" v-model="nouveauDiplome.libelle" placeholder="Libellé..." required>
                                                  </div>
                                                </div>
                                                <div class="form-group ml-4 mr-4" >
                                                  <label for="inputAddress">Descriptif</label>
                                                  <textarea type="text" class="form-control" id="inputAddress" v-model="nouveauDiplome.descriptif" placeholder="Cours descriptif du diplome..." required></textarea>
                                                </div>
                                                
                                                <div class="form-row ml-4 mr-4">
                                                  <div class="form-group col-md-6">
                                                    <label for="inputCity">Responsable</label>
                                                    <input type="text" class="form-control" id="inputCity" v-model="nouveauDiplome.responsable" placeholder="Enseignant responsable..." required>
                                                  </div>
                                                </div>
                                                <div class="form-row ml-4 mr-4">
                                                  ...
                                                  <div class="form-group col-md-12">
                                                    ...
                                                    <div class="form-row form-group">
                                                        <select id="inputState" placeholder="Choisir un type..." class="form-control custom-select col-md-8" v-model="nouveauDiplome.type" required>
